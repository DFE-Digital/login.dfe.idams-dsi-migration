...
# az network private-endpoint create --name "pirean-appinsight-private-endpoint" --resource-group $resourceGroupName --subnet $subnetId --private-connection-resource-id $privateConnectionResourceId --connection-name "connection-pirean-private-link" --location $location --group-ids "azuremonitor"
az network private-link-service connection approve --service-name $applicationInsightsName --name "connection-pirean-private-link" --resource-group $resourceGroupName
