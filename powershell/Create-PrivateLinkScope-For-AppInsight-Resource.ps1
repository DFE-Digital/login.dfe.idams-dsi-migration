...
az network private-endpoint create --name "pirean-appinsight-private-endpoint" --resource-group $resourceGroupName --subnet $subnetId --private-connection-resource-id $privateConnectionResourceId --connection-name "connection-pirean-private-link" --location $location
